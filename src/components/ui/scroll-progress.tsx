...
//    an arbitrary-value class like top-[72px] is a cascade gamble; inline is not.
...
//    past 72px when the mobile menu opens, and the header should paint over the
//    bar rather than the other way round.
